...
All of them — individual exams, course + exam bundles, and the Kubestronaut / Golden Kubestronaut bundles.
...
Tux Rewards (a 50% coupon earned after spending $500+) is a separate program with its own coupon, and checkouts only accept one coupon code at a time — but nothing stops you from using `RUSHABH30` today and earning toward Tux Rewards for a future purchase.
